        ...
        >
            <DialogTitle sx={{
                ...
                <div className='flex items-center' >
                    ...
                    <div className="ml-3 flex items-center text-xs cursor-pointer" style={{
                        ...
                        <span className='text-center   border-l border-t inline-block  border-b border-[var(--color-border)] rounded-l-full px-2 ' style={{
                            lineHeight: '22px',
                            ...(isSimpleMode ? {} : { color: 'var(--color-primary)', borderColor: 'var(--color-primary-light)', backgroundColor: 'var(--color-primary-light2)' })
                        }}
                        ...
                        <span className='text-center border-r border-t inline-block  border-b border-[var(--color-border)] rounded-r-full px-2 ' style={{
                            lineHeight: '22px',
                            ...(isSimpleMode ? { color: 'var(--color-primary)', borderColor: 'var(--color-primary-light)', backgroundColor: 'var(--color-primary-light2)' } : {})
                        }}
                            onClick={() => setSimpleMode(() => {
            ...
            <DialogContent dividers className='!px-4'>
                ...
                <div className="p-3 pl-0 flex items-center gap-2">
                    <svg className="w-5 h-5 text-[var(--color-text-secondary)] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className=" p-3 bg-[var(--color-bg-primary)] rounded-lg border border-[var(--color-border)] text-sm">
                    <div className="font-medium text-[var(--color-text-primary)] mb-3 flex items-center gap-2">
